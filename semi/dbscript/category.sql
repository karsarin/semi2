...
COMMENT ON COLUMN CATEGORY_GROUP.GROUP_NO IS '카테고리번호';
COMMENT ON COLUMN CATEGORY_GROUP.GROUP_NAME IS '카테고리이름';
...
COMMENT ON COLUMN CATEGORY_BOARD.SPECIAL IS '이색재능';
COMMENT ON COLUMN CATEGORY_BOARD.APPROVAL IS '승인';
